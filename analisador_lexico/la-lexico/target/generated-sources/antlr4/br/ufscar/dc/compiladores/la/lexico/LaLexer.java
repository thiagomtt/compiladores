...
public class LaLexer extends Lexer {
	...
	public static final int
		...
		ATRIBUICAO=48, AD=49, SUB=50, DIV=51, RESTO=52, MULT=53, CHAPEU=54, EE=55, 
		PONTO=56, SEQUENCIA=57, DOIS_PONTOS=58, VIRGULA=59, ABREPAR=60, FECHAPAR=61, 
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"AD", "SUB", "DIV", "RESTO", "MULT", "CHAPEU", "EE", "PONTO", "SEQUENCIA", 
			"DOIS_PONTOS", "VIRGULA", "ABREPAR", "FECHAPAR", "ABRECOL", "FECHACOL", 
			"COMENTARIO", "WS", "COMENTARIO_ERRADO", "CADEIA_ERRADA", "ERRO"
		};
	}
